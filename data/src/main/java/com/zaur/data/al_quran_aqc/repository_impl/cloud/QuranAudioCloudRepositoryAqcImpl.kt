...
class QuranAudioCloudRepositoryAqcImpl(
    ...
    override suspend fun getChapterAudioOfReciterCloud(
        chapterNumber: Int,
        reciter: String,
    ): ChapterAudioFile = quranApiAqc.getChapterAudioOfReciter(chapterNumber, reciter).chapterAudio

    override suspend fun getAyahAudioByKeyCloud(
        verseKey: String,
        reciter: String,
    ): VerseAudioAqc = quranApiAqc.getAyahAudioByKey(verseKey, reciter).versesAudio
}